...
<body class="bg-default">
            ...
            <div class="card-body px-lg-5 py-lg-5">
             <!--  <div class="text-center text-muted mb-4">
                <small>Or sign in with credentials</small>
                    ...
                    <form method="POST" action="{{ route('signup.ref',[$ref]) }}">
                        @csrf
 <div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="fas fa-wallet"></i></span>
                                ...
                                <input id="name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="address" value="{{ old('first_name') }}"  autocomplete="address" required autofocus>
          ...
          <div class="row mt-3">
            <div class="col-6">
              <a class="text-light" href="{{ route('address.request') }}">
                                        Forgot Your Address ?
                                    </a>
                                         </div>

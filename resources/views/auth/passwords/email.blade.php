...
<body class="bg-default">
 ...
 <input id="email" class="form-control @error('id') is-invalid @enderror" name="id" value="{{ old('id') }}" required autocomplete="id" placeholder="Enter Your User Token" autofocus>                     @error('id')
 ...
 <input id="email" class="form-control @error('first_name') is-invalid @enderror" name="address" value="{{ old('first_name') }}" required autocomplete="address" placeholder="MetaMask Wallet Address" autofocus>                     @error('first_name')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                                @enderror

            ...
            <div class="card-header bg-transparent pb-5">
             ...
             <div class="card-body">
                        <div class="alert alert-danger" role="alert">
                            {{ __('Please Select Address Which Use For Register Otherwise Changed Your Forgot Your Password With Your User Token.') }}
                        </div>

                     <div class="text-center">
                  <a href="{{asset('home')}}" class="btn btn-primary my-4">back</a>
                </div>
                </div>
            </div>
